...
class ImageSubscriber(Node):
    def __init__(self):
        ...
        self.blobs_front = self.create_publisher(Int32, "/pixels/front", 10)
        self.blobs_back = self.create_publisher(Int32, "/pixels/back", 10)
    ...
    def camera_front(self, img, gps):
        ...
        image, _ = self.blober(image, self.blobs_front)
    ...
    def camera_back(self, img, gps):
        ...
        image, _ = self.blober(image, self.blobs_back)
