...
class Tracktor(Node):
    def __init__(self):
        ...
        self.yolo_front_pub = self.create_publisher(Image, '/Pioneer3at/camera_front/yolo', 10)
        self.yolo_back_pub = self.create_publisher(Image, '/Pioneer3at/camera_back/yolo', 10)
    ...
    def callback_front(self, image, distance):
        ...
        labeled_yolo_frame = self.bridge.cv2_to_imgmsg(image_clone, encoding='bgr8')
        self.yolo_front_pub.publish(labeled_yolo_frame)
    ...
    def callback_back(self, image, distance):
        ...
        labeled_yolo_frame = self.bridge.cv2_to_imgmsg(image_clone, encoding='bgr8')
        self.yolo_back_pub.publish(labeled_yolo_frame)
